...
class MatchVC: UIViewController, UITextFieldDelegate {
    ...
    let messageTxt: UITextField = {
        ...
        textField.rightView = UIView(
            frame: CGRect(x: 0, y: 0, width: 90, height: 0)
        )
    ...
    let messageSendButton: UIButton = {
        ...
        button.setTitleColor(
            UIColor(red: 62/255, green: 163/255, blue: 255/255, alpha: 1),
            for: .normal
        )
    ...
    override func viewDidLoad() {
        ...
        messageTxt.addSubview(messageSendButton)
        ...
        let stackView = UIStackView(
            arrangedSubviews:
                [likeImageView, messageLabel, messageTxt, backButton]
        )
